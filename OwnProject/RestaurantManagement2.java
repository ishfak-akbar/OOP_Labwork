...
public class RestaurantManagement2 extends JFrame 
{
    ...
    public static void menu()
    {
        ...
        String opt = JOptionPane.showInputDialog(null,"What would you like to have today?\n"
                        + "\n----------MENU----------\n1.Main Dish\n2.Kebab\n3.Coffee/Deserts\n\n",
        ...
        switch (opt)
        {
            ...
            case "2":
                ...
                customerOrders.add(new Order("Kebab", ("1".equals(selectKebab)) ? "TENGDI KEBAB" : "RESHMI KEBAB", price1));
            ...
            case "3":
                ...
                customerOrders.add(new Order("Dessert", ("1".equals(selectDesert)) ? "BLENDED OREO COLD" : "NUTELLA WAFFLE", price2));
                break;
